			...
			<div class="contenttop">
				<div class="left">
					<form action="handler.php?action=tambah_kategori" method="post">
						...
						<button style="background: #41b3f9;color: #fff;border-radius: 3px;border-color: #41b3f9;border:1px solid #41b3f9"><i class="fa fa-plus-square"></i> Tambah Kategori</button>
					</form>
				</div>
				<div class="both"></div>
			</div>
