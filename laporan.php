...
<div class="content">
    ...
    <form action="cetak_laporan.php" style="display: inline;" target="_blank" method="post">
					...
					<button class="btn-ctk" style="background: #41b3f9;color: #fff;border-radius: 3px;border-color: #41b3f9;border:1px solid #41b3f9" <?php if (isset($_GET['filter_record'])) {}else{ ?> disabled="disabled" title="Pilih jenis dan tanggal lebih dulu"<?php } ?>><i class="fa fa-file-pdf-o"></i> Cetak</button>
					</form>
				</div>
				<div class="both"></div>
			</div>
